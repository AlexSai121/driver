...
![Type](https://img.shields.io/badge/architecture-Local--First-orange.svg)
...
- **Notes**: A focused editor for quick thoughts and deep work.
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/AlexSai121/driver.git
   cd driver
   ```
...
4. The **Black Gear** icon will appear on your home screen, launching the app in fullscreen mode.
...
- **Icons**: Lucide React
- **Audio**: Web Audio API with custom mechanical samples
...
---
*Built for the enthusiasts who want their productivity tools to feel like high-performance machinery.*
